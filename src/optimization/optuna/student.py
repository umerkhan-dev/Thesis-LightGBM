...
joblib.dump(best_model, 'student_bst_rand.joblib')

print("Best Model Parameters:", best_params)

# Access the results of each hyperparameter set
results = pd.DataFrame(random_search.cv_results_)
results.to_csv('student_random_ppr.txt')
...
output_file_path = os.path.join(os.getcwd(), 'student_random_per_fold_results.csv')
...
output_file_name = 'student_random_metrics_output.md'
