...
results.to_csv('phishing_random_ppr.txt', sep='\t', index=True)
...
output_file_path = os.path.join(os.getcwd(), 'phishing_random_per_fold_results.csv')
...
output_file_name = 'phishing_random_metrics_output.md'
...
plt.savefig('phishing_random_auc_roc_plot.png')
plt.show()
...
plt.savefig('cm_phishing_random_plot.png')
