...
results.to_csv('breast_cancer_per_param_results.txt', sep='\t', index=True)
...
output_file_path = os.path.join(os.getcwd(), 'Breast_cancer_random_ppr.csv')
...
output_file_name = 'Breast_cancer_random_metrics_output.md'
...
plt.savefig('Breast_cancer_random_auc_roc_plot.png')
...
plt.savefig('Breast_cancer_random_marketing_plot.png')
