...
model_filename = 'apple_model.joblib'
...
results.to_csv('apple_ppr.txt', sep='\t', index=True)
...
output_file_path = os.path.join(os.getcwd(), 'apple_Grid_per_fold_results.csv')
...
output_file_name = 'apple_grid_metrics_output.md'
...
plt.savefig('apple_marketing_auc_roc_plot.png')
...
plt.savefig('cm_apple_marketing_plot.png')
end_time = time.time()
