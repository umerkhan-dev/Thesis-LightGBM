...
def format_caption(file_name):
    ...
    new_caption = f"Metrics Summary for {dataset_name.capitalize()} with Grid search"
    return new_caption
...
if __name__ == "__main__":
    folder_path = "/Users/umarkhan/Desktop/grid_search/Breast_cancer_grid_ppr2.csv"
    table_folder = "/Users/umarkhan/Desktop/grid_search/latex_tables2"
    file_name = 'Breast_cancer_grid_ppr2.csv'
