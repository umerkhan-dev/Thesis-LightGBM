...
results.to_csv('breas_cancer_per_param_results2.txt', sep='\t', index=True)
...
output_file_path = os.path.join(os.getcwd(), 'Breast_cancer_grid_ppr2.csv')
...
output_file_name = 'Breast_cancer_grid_metrics_output2.md'
...
plt.savefig('Breast_cancer_grid_auc_roc_plot.png')
...
plt.savefig('Breast_cancer_grid_marketing_plot.png')
